...
import com.lealpy.help_app.data.utils.toNkoEntities
import com.lealpy.help_app.data.utils.toNkoItems
                ...
                getFromDbAllNkoItems()
                    .flatMap { nkoItemsFromDb ->
                        if (nkoItemsFromDb.isNotEmpty()) {
                            ...
                            val nkoItemsFromFile =
                                utils.getItemsFromFile<List<NkoItem>>(NKO_ITEMS_FILE_NAME)
