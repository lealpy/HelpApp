...
class NewsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun getNewsItemsFromJSON() {
        ...
        executorService.execute {
            ...
            val gson = Gson()
            val itemTypes = object : TypeToken<List<NewsItem>>() {}.type
            val newsItemsFromJson : List<NewsItem> = gson.fromJson(jsonFileString, itemTypes)
            _newsItems.postValue(newsItemsFromJson)
