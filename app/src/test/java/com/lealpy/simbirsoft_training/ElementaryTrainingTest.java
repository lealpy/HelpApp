...
public class ElementaryTrainingTest {
    ...
    @Test
    public void swapNumbers_fiveDigitNumber() throws Exception {
    ...
    @Test
    public void swapNumbers_twoDigitNumber() throws Exception {
    ...
    @Test
    public void swapNumbers_oneDigitNumber() throws Exception {
    ...
    @Test
    public void zeroEvenNumber_fiveDigitNumber() throws Exception {
    ...
    @Test
    public void zeroEvenNumber_twoDigitNumber() throws Exception {
    ...
    @Test
    public void zeroEvenNumber_oneDigitNumber() throws Exception {
